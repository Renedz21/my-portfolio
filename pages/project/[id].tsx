...
import tmpImage from '@/assets/image-retroethical-1.webp'
...
const ProjectDetail = () => {
    ...
    useEffect(() => {
        const getOneProject = async () => {
            const result = await axios.get(`https://my-portfolio-be.onrender.com/api/project/${id}`);
    ...
    return (
        <div>
            ...
            {isLoading ? (
                ...
                <>
                    <div className="container mx-auto w-full h-full flex px-5 md:py-24 pt-8 md:flex-row flex-col items-center">
