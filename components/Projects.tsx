        ...
        <section id='projects' className='w-full'>
            <div className='flex flex-col flex-1'>
                ...
                <div className='flex flex-wrap justify-center items-center'>
                    <div className='w-[270px] flex items-center justify-center flex-col m-8 p-4 rounded-lg bg-white text-[#000] cursor-pointer transition-all ease-linear duration-300'>
                        {/* map */}
