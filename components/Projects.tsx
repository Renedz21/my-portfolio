...
const options = {
    ...
    revalidateOnFocus: false, // No renovar al enfocar la pestaña
    revalidateOnReconnect: false, // No renovar al reconectar
    refreshInterval: 60 * 60 * 1000, // Cada hora
    dedupingInterval: 10 * 1000, // Evita solicitudes duplicadas en 10 segundos
};
...
const Projects = () => {
    ...
    const { data, error, isLoading } = useSWR('https://my-portfolio-be.onrender.com/api/project', fetcher, options)
