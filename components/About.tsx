...
const About = () => {
    return (
        <section id='about' className='md:my-24 my-0 w-full md:w-auto p-6 md:p-0'>
            <div className='flex flex-col items-center justify-center'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 justify-items-stretch items-center justify-center'>
                    <div className='mb-16 md:mb-0'>
                        <Image src={cloudImage} className='h-[270px] md:h-[450px]' alt='cloud' />
                    </div>
                    <div className='text-justify text-white text-2xl'>
